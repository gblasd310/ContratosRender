...
#np.savetxt("C:\\GeneracionContratos\\outputs\\DataPDF_PRINCEPS_12500_CON_ACCESORIOS.csv", DATA_FILES_PDF, delimiter =",",fmt ='% s')
np.savetxt("C:\\GeneracionContratos\\outputs\\DataPDF_26-10-2022-00000.csv", DATA_FILES_PDF, delimiter =",",fmt ='% s')
