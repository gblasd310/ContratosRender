...
for dt in carta.index:
  ...
  if  str(carta['condonacion'][dt]) != "NO APLICA":
    ...
    context['cond'] = '{:,.2f}'.format(float(carta['condonacion'][dt]))
    
    if len(str(carta['condonacion'][dt]).split('.')) > 0:
  ...
  if 'cond' in context:
    ...
    print("[" + str(dt) + "] >>> " + str(carta['nombre'][dt]).strip()+"_"+str(carta['credito'][dt])+"_"+str(carta['vin'][dt])+"_"+str(int(carta['mensualidad'][dt]))+".docx")
  else:
    ...
    EnrutaMasConvenioModificatorio.save(fileDir+"/"+str(carta['nombre'][dt]).strip()+"_"+str(carta['credito'][dt])+"_"+str(carta['vin'][dt])+"_"+str(int(carta['mensualidad'][dt]))+".docx")
    print("[" + str(dt) + "] >>> " + str(carta['nombre'][dt]).strip()+"_"+str(carta['credito'][dt])+"_"+str(carta['vin'][dt])+"_"+str(int(carta['mensualidad'][dt]))+".docx")
